...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60029"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-v1",
      "problem_contract_sha256": "d7fa3b6cd9b0525ceff4b7324cc27161b59b03d8ba950cfbd1117d0d6b9324ff",
      "problem_id": "problem:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895",
      "route_id": "route:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-source-fidelity-01",
      "graph_id": "graph:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $G$ be a $2$-connected cubic graph and let $S$ be a $2$-regular subgraph such that $G-E(S)$ is connected. Then $G$ has a cycle double cover which contains $S$ (i.e all cycles of $S$ )."
          },
          "statement_sha256": "0216aee88e70c70a3c228dcc64d97ccc8844e444d6cd740d435085f4a3c300c4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-root",
      "route_id": "route:um-opg-60029-cycle-double-covers-containing-predefi-bcd66895-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60029-a7f1e747da83",
        "url": "https://www.unsolvedmath.com/problems/OPG-60029"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
